...
const BASE_URL = 'https://kca-seven.vercel.app';
...
const endpoints: Endpoint[] = [
    {
        ...
        params: [
            ...
            { name: 'secret', type: 'string', required: true, desc: 'Your app secret key (from Dashboard)', example: '"kca-abc123..."' },
  ...
  body: JSON.stringify({
    ...
    },
    {
        ...
        params: [
            ...
            { name: 'licenseKey', type: 'string', required: true, desc: 'A valid unused license key', example: '"KCA-ABCD-EFGH"' },
            { name: 'secret', type: 'string', required: true, desc: 'Your app secret key', example: '"kca-abc123..."' },
  ...
  body: JSON.stringify({
    ...
    },
    {
        ...
        params: [
            ...
            { name: 'secret', type: 'string', required: true, desc: 'Your app secret', example: '"kca-abc123..."' },
            { name: 'appName', type: 'string', required: true, desc: 'Application name', example: '"MyApp"' },
    ...
    },
    {
        ...
        params: [
            ...
            { name: 'secret', type: 'string', required: true, desc: 'Your app secret', example: '"kca-abc123..."' },
            { name: 'appName', type: 'string', required: true, desc: 'Application name', example: '"MyApp"' },
            { name: 'licenseKey', type: 'string', required: true, desc: 'The license key string', example: '"KCA-XXXX-YYYY"' },
    ...
    },
    {
        ...
        params: [
            ...
            { name: 'secret', type: 'string', required: true, desc: 'Your app secret', example: '"kca-abc123..."' },
            { name: 'appName', type: 'string', required: true, desc: 'Application name', example: '"MyApp"' },
            { name: 'licenseKey', type: 'string', required: true, desc: 'License to delete', example: '"KCA-XXXX-YYYY"' },
        ],
        responses: [
    ...
    },
    {
        ...
        params: [
            { name: 'ownerEmailKey', type: 'string', required: true, desc: 'Your account email key', example: '"user,example,com"' },
            { name: 'secret', type: 'string', required: true, desc: 'Your master secret', example: '"kca-abc123..."' },
    ...
    <div className="space-y-8">
        <div>
            ...
            <p className="text-muted text-base leading-relaxed max-w-2xl">
                Get up and running with KCA in 3 steps. No complex setup — just a secret key and a few HTTP requests.
            </p>
        </div>
            ...
            {[
                {
                    ...
                    desc: 'Go to your Dashboard → select your application → copy the Secret Key shown at the top. It looks like kca-xxxxxxxx...',
                    code: `
const SECRET = "kca-abc123..."
const APP    = "MyApp"
const VERSION = "1.0.0"`
                },
                {
            ...
            <div className="flex-1 flex max-w-[88rem] mx-auto w-full pt-16 relative z-10">
                ...
                <main className="flex-1 p-6 lg:p-10 min-w-0">
                    ...
                    <div className="mt-16 pt-8 border-t border-white/[0.05] text-center">
                        <p className="text-muted/40 text-xs">KCA Authentication · All endpoints use HTTPS</p>
                    </div>
                </main>
            </div>
        </div>
